...
5. Extract the file and copy "Online Course registartion" folder
...
8. Create a database with name onlinecourse

6. Import onlinecourse.sql file(given inside the zip package in SQL file folder)

7.Run the script http://localhost/Online course registartion
